              ...
              <div className="o-grid-col o-grid-col_9of12 o-mix-grid-col_offset1of12">
                <div className="o-titleBar">
                  <div className="o-titleBar-preamble">
                    <span className="c-txt c-txt_catMeta">Interview</span>
                  </div>
                  ...
                  <div className="o-titleBar-summary o-titleBar-summary_constrained">
                    <span className="c-hdgSans c-hdgSans_7">Clare Bucknell&rsquo;s<em> The Treasuries</em> examines how poetry anthologies have shaped national identity&mdash;and preserved some interviews better left forgotten.</span>
                  </div>
                        ...
                        <ul className="c-vList c-vList_bordered">
                          ...
                          <li>
                            <div className="c-feature c-mix-feature_shrinkwrap">
                              <div className="c-feature-preamble">
                                <span
                                  className="c-txt c-txt_attribution">Related Interviews</span>
                                <ul>
                                  <li>
